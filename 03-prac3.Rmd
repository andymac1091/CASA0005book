...
# Create an empty grid where n is the total number of cells, however this is overwritten based on cell size.
...
Wait... didn't we use ```crop``` earlier and now we are using ```mask```?....Yes. For most circumstances you could use either, but check the RDocumentation[https://www.rdocumentation.org/] for more information.  
